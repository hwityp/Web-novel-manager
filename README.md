...
| 버전 | 날짜 | 주요 변경 사항 |
| ------ | ------ | ---------------- |
| **v1.3.45** | 2026-09-17 | **해외 플랫폼 스크래핑 & 장르 분류 고도화**: 중국/일본 플랫폼(치뎬, 진장, 바이두, 나로우, 카쿠요무) 추출기 추가, WAF 403 회로차단기(Circuit Breaker), 정적 타입 검사기 안정화 |
| **v1.3.44** | 2026-09-09 | **장르 판별 엔진 정밀화**: CP949 멀티바이트 인코딩 복원, 중국 웹소설 키워드(어수/역병/선협/완미세계) 대규모 확충, 린터 타입 정합성 완비 |
